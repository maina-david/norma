...
return new class() extends Migration {
    ...
    public function up()
    {
        Schema::create('reference_requirement_drafts', function (Blueprint $table) {
    ...
    {
        Schema::table('reference_requirement_drafts', function (Blueprint $table) {
            $table->dropForeign(['annotation_source_id']);
            $table->dropForeign(['approved_by']);
            $table->dropForeign(['applied_by']);
            $table->dropForeign(['reference_id']);
        });
        Schema::dropIfExists('reference_requirement_drafts');
    }
};
