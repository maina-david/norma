...
class PdfExtractorTest extends TestCase
{
    public function testGetProperty(): void
    {
        ...
        $this->assertSame('Norma Test PDF', app(PdfExtractor::class)->getProperty(PdfProperty::TITLE, $pdf));
        $this->assertSame('Norma test pdf subject', app(PdfExtractor::class)->getProperty(PdfProperty::SUBJECT, $pdf));
        $this->assertSame('norma, test, pdf', app(PdfExtractor::class)->getProperty(PdfProperty::KEYWORDS, $pdf));
