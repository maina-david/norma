...
namespace Tests\Feature\NormaAI;
...
class NormaAIClientTest extends TestCase
{
    /**
     * @return void
     */
    ...
    {
        Config::set('services.norma_ai.enabled', false);
    ...
    public function testMagiSearchEngine(): void
    {
        ...
        Http::fake([
            'norma-ai.norma.rocks:7000/*' => Http::sequence()
