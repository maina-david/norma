              ...
              <div class="sm:flex sm:items-center sm:justify-between">
                <div class="sm:flex sm:space-x-5">
                  ...
                  <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                    <p class="text-sm font-medium text-norma-gray-600">{{ __('collaborators.welcome_back') }},</p>
                    <p class="text-xl font-bold text-norma-gray-900 sm:text-2xl">{{ $collaborator->full_name }}</p>
                    <p class="text-sm font-medium text-norma-gray-600">
                      {!! __('collaborators.collaborator.turk_level', ['level' => ceil(($collaborator->completed_tasks_count ?? 1) / 100)]) !!}
                    </p>
                  </div>
                </div>
                <div class="mt-5 flex justify-center sm:mt-0">
                  <a href="{{ route('collaborate.profile.show') }}" class="flex justify-center items-center px-4 py-2 border border-norma-gray-300 shadow-sm text-sm font-medium rounded-md text-norma-gray-700 bg-white hover:bg-norma-gray-50">
                    {{ __('collaborators.view_profile') }}
                  </a>
                </div>
              </div>
            </div>
            <div class="border-t border-norma-gray-200 bg-norma-gray-50 grid grid-cols-1 divide-y divide-norma-gray-200 sm:grid-cols-4 sm:divide-y-0 sm:divide-x">
