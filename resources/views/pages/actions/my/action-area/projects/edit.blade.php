<x-layouts.app>
  <x-slot name="header">
    <a href="{{ route('my.projects.index') }}" class="text-primary mr-3">
  ...
  <div class="shadow bg-white p-5 max-w-screen-md mx-auto">
    <x-ui.form :action="route('my.projects.update', ['project' => $project->id])" method="put">
  ...
  <div class="shadow bg-white p-5 max-w-screen-md mx-auto mt-20 flex flex-row justify-between">
    <div>
      <x-ui.confirm-modal :route="route('my.projects.destroy', ['project' => $project->id])"
    ...
    <div>
      @if ($project->archived)
        <x-ui.confirm-modal :route="route('my.projects.unarchive', ['project' => $project->id])"
                            data-turbo-frame="_top"
                            method="post"
      ...
      @else
        <x-ui.confirm-modal :route="route('my.projects.archive', ['project' => $project->id])"
                            data-turbo-frame="_top"
                            method="post"
