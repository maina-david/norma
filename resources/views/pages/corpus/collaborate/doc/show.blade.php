...
<div class="bg-white shadow overflow-hidden sm:rounded-lg">
  <div class="px-4 py-5 sm:px-6">
    <h3 class="text-lg leading-6 font-medium text-norma-gray-900">
      <a href="{{ route('collaborate.corpus.docs.preview', ['doc' => $resource->id]) }}">{{ $resource->title }}</a>
    </h3>
    <p class="mt-1 max-w-2xl text-sm text-norma-gray-500">
  ...
  <div class="border-t border-norma-gray-200 px-4 py-5 sm:p-0">
    <dl class="sm:divide-y sm:divide-norma-gray-200">
      <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <dd class="mt-1 text-sm text-norma-gray-900 sm:mt-0 sm:col-span-2">
          {{ $resource->id }}
        </dd>
      </div>
      <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
