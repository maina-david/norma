@php use App\Enums\Compilation\ContextQuestionAnswer; @endphp

@if($pendingApplicability > 0)
  <x-ui.modal
    :closable="false"
    x-init="function () {
  ...
  >
    ...
    <div class="max-w-md text-sm px-2">
      ...
      <div class="flex justify-end items-center mt-2 border-t border-libryo-gray-200 pt-4">
        ...
        <x-ui.button type="link" styling="outline" theme="primary" class="ml-2" href="{{ route('my.context-questions.index', ['answer' => [ContextQuestionAnswer::maybe()->value]]) }}">
