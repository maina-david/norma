...
<p style="text-align: center;font-size: 18px; color: #014E35;margin-bottom: 35px;">
{!! $introLine !!}
</p>
...
@component('mail::task-table', ['url' => $url, 'item' => $item, 'task' => $task, 'assignedTo' => $assignedTo, 'due_on' => $due_on])
@endcomponent
