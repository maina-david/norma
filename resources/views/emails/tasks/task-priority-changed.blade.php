...
@component('mail::task-mail-description', [
    'introLine' => trans('tasks.priority_changed_task', ['title' => $task->title]),
    'main' => trans('tasks.priority_changed_from', ['from' => __('tasks.task.priority.' . $fromPriority), 'to' => __('tasks.task.priority.' . $toPriority)])
])
@endcomponent
