...
const filterNames = {
  ...
  actionAreasWithDrafts: 'actionAreasWithDrafts',
...
export const useReferenceVisibility = (init = {}) => {
  const referenceVisibility = reactive({
    actionAreas: ReferenceVisibility.ALL,
  ...
  const fillableFilters = [
    'actionAreasWithDrafts', 'assessmentItemsWithDrafts', 'questionsWithDrafts', 'locationsWithDrafts',
    'domainsWithDrafts', 'topicsWithDrafts',
  ];
