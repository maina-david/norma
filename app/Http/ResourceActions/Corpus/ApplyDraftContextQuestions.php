...
class ApplyDraftContextQuestions extends ApplyDraftTaggables
{
    ...
    {
        return $user && $user->can('collaborate.corpus.work-expression.apply-context-questions');
    }
    ...
    {
        return 'apply-context-question-drafts';
    }
}
