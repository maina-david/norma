...
use App\Jobs\Corpus\AttemptMatchingTocItemsToReferences;
use App\Models\Auth\User;
use Illuminate\Http\RedirectResponse;
use Illuminate\Http\Request;

class AttemptMatchingTocToReference implements ResourceAction
{
    /**
     * @param int $workId
    ...
    {
        return $user && $user->can('collaborate.corpus.reference.apply');
    }
    ...
    {
        /** @var string */
        return __('corpus.reference.attempt_matching');
    }
    ...
    {
        dispatch(new AttemptMatchingTocItemsToReferences($this->workId));
