...
class DeleteDraftSummaries implements ResourceAction
{
    /**
     * @param int $workId
    ...
    {
        return $user && $user->can('collaborate.requirements.summary.draft.delete');
    }
    ...
    {
        /** @var string */
        return __('corpus.reference.delete_summary_drafts');
    }
