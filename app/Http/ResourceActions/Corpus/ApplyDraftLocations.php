...
class ApplyDraftLocations extends ApplyDraftTaggables
{
    ...
    {
        return $user && $user->can('collaborate.corpus.work-expression.apply-locations');
    }
