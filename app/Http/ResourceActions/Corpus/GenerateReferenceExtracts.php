...
class GenerateReferenceExtracts implements ResourceAction
{
    /**
     * @param int $workId
    ...
    {
        return $user && $user->can('collaborate.corpus.reference-content-extract.create');
    }
    ...
    {
        /** @var string */
        return __('corpus.work_expression.generate_extracts');
    }
    ...
    {
        GenerateExtracts::dispatch($resourceIds);
