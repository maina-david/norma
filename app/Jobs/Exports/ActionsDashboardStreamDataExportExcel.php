...
class ActionsDashboardStreamDataExportExcel implements ShouldQueue, TrackableJobInterface
{
    use Dispatchable;
    ...
    /**
     * @param DashboardStreamDataExport $exporter
     *
     * @throws Exception
     ...
     * @return void
     */
    public function handle(DashboardStreamDataExport $exporter): void
    {
